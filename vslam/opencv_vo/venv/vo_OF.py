...
from vo_live_plot_log import (
    initialize_live_plot_and_logging,
...
picam2.start()
time.sleep(1)  # Beri waktu kamera untuk warm-up
...
cur_pose = start_pose
fig, ax2d, x_data, z_data, csv_file, csv_writer = initialize_live_plot_and_logging()
