...
class YUVStreamer:
    def __init__(self, pipe_path="live.yuv", output_dir="dataset", width=640, height=480, interval=5.0):
...
def main():
    ...
    streamer = YUVStreamer(pipe_path=pipe_path, output_dir=output_dir, width=width, height=height, interval=5.0)
    try:
        streamer.run()
